# Generated by Django 4.2 on 2024-01-29 00:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(max_length=1050, verbose_name='内容')),
                ('created_date', models.DateField(null=True, verbose_name='作成日時')),
                ('updated_date', models.DateField(auto_now=True, null=True, verbose_name='更新日時')),
                ...
                ('counseling', models.IntegerField(default=0, verbose_name='カウンセリング可否')),
