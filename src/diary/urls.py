...
urlpatterns = [
    ...
    path('create/diary/confirmation/<int:pk>', views.create_diary_confirmation,name='create_diary_confirmation'),
    ...
    path('diary/update/<int:diary_id>', views.diary_update,name='diary_update'),
