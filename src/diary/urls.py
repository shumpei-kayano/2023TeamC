...
urlpatterns = [
    ...
    path('record/diary/graph<int:pk>', views.record_diary_graph,name='record_diary_graph'),
    ...
    path('today/counseling_red/<int:pk>', views.counseling_red,name='counseling_red'),
